 ...
 final TextEditingController _descriptionController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return _image == null? _uploadPostWidget() : Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: backGroundColor,
        leading: GestureDetector(onTap: () => setState(() => _image = null),child: const Icon(Icons.close, size: 28,)),
        actions: [
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: GestureDetector(onTap: _submitPost,child: const Icon(Icons.arrow_forward)),
          )
        ],
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            sizeVer(10),
            Text("${widget.currentUser.username}", style: const TextStyle(color: Colors.white),),
            sizeVer(10),
            SizedBox(
